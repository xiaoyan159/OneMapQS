...
public class NavinfoMixinTileSource extends GeojsonTileSource {
    ...
    private NavinfoGeoJsonEncodeTileSource geojsonTileSource;
    private MultiMapFileTileSource multiMapFileTileSource;
    public static class Builder<T extends Builder<T>> extends GeojsonTileSource.Builder<T> {
        ...
        public T geojsonTileSource(NavinfoGeoJsonEncodeTileSource geojsonTileSource) {
            this.geojsonTileSource = geojsonTileSource;
            return self();
        }

        public T multiMapFileTileSource(MultiMapFileTileSource multiMapFileTileSource) {
            this.multiMapFileTileSource = multiMapFileTileSource;
            return self();
        }

        @Override
        public NavinfoMixinTileSource build() {
            return new NavinfoMixinTileSource(this);
        }
    }
    ...
    public NavinfoMixinTileSource(Builder<?> builder) {
        super(builder);
        this.locale = builder.locale;
    }

    public NavinfoMixinTileSource() {
        this(builder());
    }

    public NavinfoMixinTileSource(String urlString) {
