...
import org.oscim.tiling.source.geojson.TileDecoder;
import org.oscim.utils.FastMath;

import java.util.LinkedHashMap;
import java.util.Map;

public class NavinfoGeoJsonTileSource extends GeojsonTileSource {
    ...
    public static class Builder<T extends Builder<T>> extends UrlTileSource.Builder<T> {
        ...
        @Override
        public NavinfoGeoJsonTileSource build() {
            return new NavinfoGeoJsonTileSource(this);
        }
    }
    ...
    public NavinfoGeoJsonTileSource(Builder<?> builder) {
        super(builder);
        this.locale = builder.locale;
    }

    public NavinfoGeoJsonTileSource() {
        this(builder());
    }

    public NavinfoGeoJsonTileSource(String urlString) {
