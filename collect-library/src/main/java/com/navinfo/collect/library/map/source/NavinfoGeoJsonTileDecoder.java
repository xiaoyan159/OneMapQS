...
import com.navinfo.collect.library.utils.Base64ZipUtils;
...
public class NavinfoGeoJsonTileDecoder implements ITileDecoder {
    ...
    public NavinfoGeoJsonTileDecoder(GeojsonTileSource tileSource) {
    ...
    public boolean decode(Tile tile, ITileDataSink sink, InputStream is) throws IOException {
        ...
        String unzipStr = Base64ZipUtils.unzipInputStream(is);
